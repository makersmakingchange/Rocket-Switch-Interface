/** ************************************************************************
 * File Name: Rocket_Switch_Interface_iOS.ino 
 * Title: Rocket Switch Interface iOS
 * Developed by: MakersMakingChange
 * Version Number: 1.1 (31/07/2023)
...
void keyboardAction(bool macMode, int switch1,int switch2) {
    if(!switch1) {
      ...
      //Serial.println("a");
      (macMode) ? keyboard.press(switchProperty[0].switchMacChar,0x00) : keyboard.press(switchProperty[0].switchChar,0x00);
    } else if(!switch2) {
      switchFeedback(2,switchMode,switchReactionTime,1);
      //Serial.println("b");
      (macMode) ? keyboard.press(switchProperty[1].switchMacChar,0x00) : keyboard.press(switchProperty[1].switchChar,0x00);
    } else
    {
      keyboard.releaseAll();
    }
